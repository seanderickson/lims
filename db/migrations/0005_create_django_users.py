    ...
    def forwards(self, orm):
        ...
        for screensaverUser in orm.ScreensaverUser.objects.all():
            if screensaverUser.ecommons_id and screensaverUser.email: 
                ...
                print 'Not creating a login user account for ', screensaverUser.screensaver_user_id, screensaverUser.ecommons_id, screensaverUser.login_id, screensaverUser.email
