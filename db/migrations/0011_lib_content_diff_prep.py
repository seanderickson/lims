...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            db.add_column(u'reagent_facility_genes', 'id',
                          self.gf('django.db.models.fields.IntegerField')(null=True),
                          keep_default=False)
            db.add_column(u'reagent_vendor_genes', 'id',
                          self.gf('django.db.models.fields.IntegerField')(null=True),
                          keep_default=False)
        except Exception, e:
    ...
    def backwards(self, orm):
        # Deleting field 'Library.version_number'
        db.delete_column(u'library', 'version_number')

        # Deleting field 'Library.loaded_by'
        db.delete_column(u'library', 'loaded_by_id')

        '''Delete all the apilog entries for ref_resource_name='well' '''
        db.delete_column(u'reagent_vendor_genes', 'id')
        db.delete_column(u'reagent_facility_genes', 'id')
    ...
    models = {
        ...
        u'db.genesymbol': {
            'Meta': {'unique_together': "((u'entrezgene_symbol', u'ordinal'),)", 'object_name': 'GeneSymbol', 'db_table': "u'gene_symbol'"},
        ...
        u'db.reagentfacilitygenes': {
            ...
            'ordinal': ('django.db.models.fields.IntegerField', [], {}),
            'reagent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['db.SilencingReagent']", 'primary_key': 'True'})
        },
