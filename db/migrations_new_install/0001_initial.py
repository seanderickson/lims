# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-08-22 15:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attached_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.AttachedFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ChecklistItem',
            fields=[
                ('checklist_item_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('checklist_item_event_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('checklist_item_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.ChecklistItemEvent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cherry_pick_assay_plate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.CherryPickAssayPlate')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='EquipmentUsed',
            fields=[
                ('equipment_used_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substance_id', models.CharField(default=db.models.create_id, max_length=8, unique=True)),
        ...
        migrations.CreateModel(
            name='SchemaHistory',
            fields=[
                ('screensaver_revision', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('screen_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.ScreenResult')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_id', models.TextField(null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('well_volume_adjustment_id', models.AutoField(primary_key=True, serialize=False)),
                ('volume', models.DecimalField(decimal_places=9, max_digits=10, null=True)),
                ('copy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Copy')),
                ('lab_cherry_pick', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.LabCherryPick')),
                ('well', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Well')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('activity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='db.Activity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('screensaver_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='db.ScreensaverUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab_head_appointment_department', models.TextField(null=True)),
                ('lab_head_appointment_update_date', models.DateField(null=True)),
                ('lab_affiliation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.LabAffiliation')),
            ],
            options={
                'db_table': 'lab_head',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab_head', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.LabHead')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='userfacilityusagerole',
            name='screensaver_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.ScreensaverUser'),
        ),
        migrations.AddField(
            model_name='userchecklist',
            name='admin_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userchecklistitems_created', to='db.ScreensaverUser'),
        ),
        migrations.AddField(
            model_name='userchecklist',
            name='screensaver_user',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_user', to='db.ScreensaverUser'),
        ),
        migrations.AddField(
            model_name='screensaveruser',
            name='lab_affiliation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lab_heads', to='db.LabAffiliation'),
        ),
        migrations.AddField(
            model_name='screensaveruser',
            name='lab_head',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lab_members', to='db.ScreensaverUser'),
        ),
        migrations.AddField(
            model_name='screensaveruser',
            name='user',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='reports.UserProfile'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pin_transfer_approved_screen', to='db.Activity'),
        ),
        migrations.AddField(
            model_name='screen',
            name='well_studied',
        ...
        migrations.AddField(
            ...
            name='cherry_pick_request',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.CherryPickRequest'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='activity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Activity'),
        ),
        migrations.AddField(
            model_name='activity',
            name='created_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('activity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='db.AdministrativeActivity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.AdministrativeActivity'),
        ),
        migrations.AddField(
            model_name='screensaveruserupdateactivity',
            name='update_activity',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.ScreeningRoomUser'),
        ),
        migrations.AlterUniqueTogether(
            name='screenfundingsupports',
        ...
        migrations.AddField(
            ...
            name='lab_activity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.LabActivity'),
        ),
        migrations.AlterUniqueTogether(
            name='copywell',
        ...
        migrations.AddField(
            model_name='cherrypickrequestupdateactivity',
            name='update_activity',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='db.AdministrativeActivity'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.AdministrativeActivity'),
        ),
        migrations.AddField(
            model_name='activityupdateactivity',
            name='update_activity',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.WellVolumeCorrectionActivity'),
        ),
        migrations.AddField(
            model_name='cherrypickassayplate',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.CherryPickScreening'),
        ),
        migrations.AlterUniqueTogether(
            name='cherrypickassayplate',
