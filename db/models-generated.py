...
class Screen(models.Model):
    ...
    is_billing_for_supplies_only = models.BooleanField()
    ...
    to_be_requested = models.BooleanField()
    ...
    screened_experimental_well_count = models.IntegerField()
    unique_screened_experimental_well_count = models.IntegerField()
    total_plated_lab_cherry_picks = models.IntegerField()
    assay_plates_screened_count = models.IntegerField()
    library_plates_screened_count = models.IntegerField()
    library_plates_data_loaded_count = models.IntegerField()
    library_plates_data_analyzed_count = models.IntegerField()
