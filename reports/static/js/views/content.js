    ...
    var ContentView = Backbone.View.extend({
        ...
        change_current_submodel : function() {
            ...
            if (content_options.view === 'home_view'){  // TODO: make into a "menu view"
                ...
                var options = _.extend( {}, detail_options, current_submodel, content_options ); // TODO: move the nested options up into the model
                    ...
                    success: function(result) {
                        ...
                        instance.fetch({
                            success: function(model){
                                ...
                                var detailView = new DetailView({ model: model}, { isEditMode: false, title: "detail", fields:result.fields}); // TODO: get the model "edit title" from the metainformation_hash
