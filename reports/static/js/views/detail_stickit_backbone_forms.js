define([
...
], function( $, _, Backbone, stickit, backbone_forms, Iccbl, 
      genericDetailTemplate, genericFormTemplate, modalOkCancel ) {
    ...
    initialize : function(attributes, options) {
      ...
      Iccbl.assert( !_.isUndefined(options.schemaResult['resource_definition']), 
          'detail view schemaResult requires a resource_definition');
      ...
      this._keys = Iccbl.sortOnOrdinal(
          _.keys(this.model.attributes), self._schemaResult.fields);
    ...
    detail: function(event) {
      ...
      // TODO: lets split edit to a different view?
      this._options.isEditMode = false; 
      var self = this;
      var detailKeys = _(this._keys).filter(function(key){
        return _.has(self._schemaResult.fields[key], 'visibility') && 
            _.contains(self._schemaResult.fields[key]['visibility'], 'detail');
      });
    ...
    edit: function(event) {
      ...
      // console.log(' template: ', genericFormTemplate, 'fields: ',
      // this._options.fields['screensaver_user_id']['title'], ', k: ' ,
      // this._keys, ', t: ', this._options.title );
      bindings = {};
      var self = this;
